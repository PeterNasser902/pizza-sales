...
The project is done in Microsoft SQL server and presented in Power BI. 
The data was loaded into 1 tables. This project involves the use of simple joins and sub-queries.
